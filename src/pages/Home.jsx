...
import { API_FILTER_CATEGORY, API_SEARCH_BY_CHAR } from '../constants'
...
function Home() {
  ...
  async function getCategory(category) {
    await axios.get(API_FILTER_CATEGORY + category)
      .then(response => {
        setMeals(response.data.meals);
      })
      .catch(error => console.log(error))
  ...
  return (
    ...
    <section className="flex flex-col gap-4 items-center">
        ...
        <div className=" p-5 w-full">
          ...
          <h3 className="text-center text-2xl my-3 font-bold bg-linear-to-r from-amber-500 to-red-500 bg-clip-text text-transparent">Categories</h3>
